...
# Zentra Order Service

Zentra Order Service is one of the components in the Zentra Microservice architecture built with Go (Golang). This service supports operations to manage user orders via RESTful API, gRPC, and Message Broker.
